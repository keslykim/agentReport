...
# CORS 설정 — Cloudflare Pages 등 외부 도메인에서의 API 호출 허용
# 배포 후 allow_origins에 실제 Cloudflare Pages URL을 추가하세요
# 예: ["https://your-project.pages.dev", "https://your-custom-domain.com"]
app.add_middleware(
    CORSMiddleware,
...
def connect_accounts():
    ...
    if count == 0:
        mock_data = [
            ...
            ("2026-06-08", "배민커넥트 배달 소득", 150000, "income", "business", "신용카드"),
            ("2026-06-07", "쿠팡이츠 배달 소득", 220000, "income", "business", "신용카드"),
            ("2026-06-06", "다이소 매장 용품", 12000, "expense", "business", "현금영수증"),
            ("2026-06-05", "알바생 주간 급여", 350000, "expense", "business", "현금영수증"),
            ("2026-06-04", "카카오 대리운전 (개인)", 35000, "expense", "personal", "신용카드"),
            ("2026-06-03", "배달의민족 저녁식사 (개인)", 28000, "expense", "personal", "신용카드")
        ]
