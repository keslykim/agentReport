                        ...
                        <section className="bg-surface-container-lowest rounded-2xl shadow-md border-t-[6px] border-primary overflow-hidden flex flex-col md:flex-row items-center justify-between p-6 md:p-10 relative">
                            ...
                            <div className="relative mt-8 md:mt-0 p-6 md:p-8 rounded-[32px] bg-[#eaf3ff] w-full md:w-1/2 border border-blue-100 flex flex-col justify-between overflow-visible shadow-sm">
                                ...
                                {transactions.length === 0 && (
                                    <div className="absolute inset-0 bg-[#eaf3ff]/95 backdrop-blur-[2px] z-30 rounded-[32px] flex flex-col items-center justify-center p-6 transition-all duration-500 animate-in fade-in">
                                        <img alt="세복이" className="w-40 h-auto object-contain drop-shadow-md mb-3 float-animation" src="/seboki2.png" />
                                        <p className="text-xl font-black text-primary text-center leading-normal">
                                            금융 정보를 불러오면<br/>
                                            실시간 세무 분석을 시작합니다!
                                        </p>
                                        <p className="text-sm text-outline mt-2 text-center font-bold">
                                            하단의 '내 카드·은행 연결하기'를 클릭해 주세요.
                                        </p>
                                    </div>
                                )}
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full">
                                    <div className="flex flex-col gap-3 w-full">
                                        ...
                                        <div className="w-full h-6 bg-surface-variant rounded-full overflow-hidden border border-outline-variant">
                                            <div className="h-full bg-primary rounded-full transition-all" style={{ width: `${dashboard.business_ratio}%` }}></div>
                                        </div>
                                    </div>
                                    <div className="flex flex-col gap-3 w-full">
                                        <div className="flex justify-between items-end">
                                        ...
                                        <div className="w-full h-6 bg-surface-variant rounded-full overflow-hidden border border-outline-variant">
                                            <div className="h-full bg-outline-variant rounded-full transition-all" style={{ width: `${dashboard.personal_ratio}%` }}></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
